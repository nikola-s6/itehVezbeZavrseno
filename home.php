...
<body>
                        ...
                        <tr id="tr-<?php echo $red["timID"] ?>">
                            ...
                            <td>
                                <label class="radio-btn">
                                    <input type="radio" name="checked-donut" id="rbc" value=<?php echo $red["timID"] ?>>
    ...
    <div class="col-md-4" style="display: block; background-color: rgba(255, 255, 255, 0.4);">
        ...
        <div style="text-align:center;">
            <h3>Izmeni tim</h3>
            <button id="btn-izmeni" onclick="izmeniPostaviPodatke()" class="btn" data-toggle="modal" data-target="#izmeniModal"><img src="image/edit.png" style="width: 25px;height: 25px;"></button>
        </div>
        <div style="text-align:center;">
            <h3>Izbrisi tim</h3>
            <button id="btn-izbrisi" onclick="izbrisi()" class="btn"><img src="image/delete.png" style="width: 25px;height: 25px;"></button>
        </div>
        <div style="text-align:center;">
